...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">{{ __('dash.students') }}
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2"
                    action="{{ route('students.store', 'test') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
