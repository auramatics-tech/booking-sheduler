                    ...
                    <table class="text-left table table-hover" id="example1" data-page-length='50'
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="wd-15p border-bottom-0"> {{ __('dash.addpoinit') }}</th>
                                    ...
                                    <td>
                                        @can('add students')
                                            <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                                data-toggle="modal" href="#modalP{{ $user->id }}"><i
                                                    class="las la-plus"></i></a>

                                            <div class="modal" id="modalP{{ $user->id }}">
                                                    ...
                                                    <div class="modal-content modal-content-demo">
                                                        ...
                                                        <form action="{{ route('addPoints') }}" method="POST">
                                                            ...
                                                            <div class="modal-body">
                                                                <p>
                                                                    {{ __('dash.addpoinitMsg') }} : {{ $user->name }}
                                                                </p><br>
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary"
                                                                    data-dismiss="modal">{{ __('dash.no') }}</button>
                                                                <button type="submit"
                                                                    class="btn btn-danger">{{ __('dash.yes') }}</button>
                                                            </div>
                                                    </div>
                                                    </form>
                                                </div>
