...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto"> {{ __('dash.teachers') }}</h4><span
            ...
            <div class="card-body">
                <div class="col-lg-12 margin-tb">
                    <div class="pull-right">
                        <a class="btn btn-primary btn-sm" href="{{ route('teachers.index') }}">
                            {{ __('dash.back') }}
                        </a>
                    </div>
                </div><br>

                {!! Form::model($user, ['method' => 'PATCH', 'route' => ['teachers.update', $user->id], 'files' => true]) !!}
                <div class="">
