...
<div class="breadcrumb-header justify-content-between">
	...
	<div class="d-flex my-xl-auto right-content">
		@can('اضافة فاتورة')
		<a href="invoices/create" class="btn btn-outline-primary btn-blockl m-2"><i class="fas fa-plus"></i>&nbsp; Add an invoice </a><br><br>
		@endcan
		@can('تصدير EXCEL')
		<a href="{{ route('invoices.export') }}" class="btn btn-outline-primary btn-blockl m-2"><i class="fas fa-file"></i>&nbsp; Excel export </a><br><br>
		@endcan
	</div>
					...
					<table id="example" class="table key-buttons text-md-nowrap">
						<thead>
							<tr>
								...
								<th class="border-bottom-0">The date of the invoice</th>
								<th class="border-bottom-0">due date</th>
								<th class="border-bottom-0">the product </th>
								<th class="border-bottom-0">Section </th>
								<th class="border-bottom-0">Discount </th>
								<th class="border-bottom-0">Tax rate </th>
								<th class="border-bottom-0">The tax amount </th>
								<th class="border-bottom-0">Total </th>
								<th class="border-bottom-0">Case </th>
						...
						<tbody>
							@foreach ($inovices as $index=>$inovice)
							<tr>
								<td>{{ $index +1 }}</td>
								...
								<td>
									<a href="InvoicesDetails/{{ $inovice->id }}">
								...
								<td>
									<div class="dropdown">
										...
										<div class="dropdown-menu tx-13">
											...
											@can('تعديل الفاتورة')
											<a class="dropdown-item" href=" {{ url('edit_invoice') }}/{{ $inovice->id }}">تعديل
												الفاتورة</a>
											@endcan

											@can('حذف الفاتورة')
											<a class="dropdown-item" href="#" data-invoice_id="{{ $inovice->id }}" data-toggle="modal" data-target="#delete_invoice"><i class="text-danger fas fa-trash-alt"></i>&nbsp;&nbsp;حذف
												الفاتورة</a>

											@endcan
											@can('تغير حالة الدفع')
											<a class="dropdown-item" href="{{ URL::route('Status_show', [$inovice->id]) }}"><i class=" text-success fas
											...
											<a class="dropdown-item" href="#" data-invoice_id="{{ $inovice->id }}" data-toggle="modal" data-target="#Transfer_invoice"><i class="text-warning fas fa-exchange-alt"></i>&nbsp;&nbsp;نقل الي
												الارشيف</a>
											@endcan

											@can('طباعةالفاتورة')

											<a class="dropdown-item" href="Print_invoice/{{ $inovice->id }}"><i class="text-success fas fa-print"></i>&nbsp;&nbsp;طباعة
												الفاتورة
											</a>
											@endcan
