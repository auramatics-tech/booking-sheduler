                                  ...
                                  <tr>
                                      ...
                                      <td>
                                          <a class="modal-effect btn btn-outline-primary btn-sm"
                                              ...
                                              <?php echo e($user->student->name ?? '---'); ?></a>
                                      ...
                                      <div class="modal-dialog modal-dialog-centered" role="document">
                                          <div class="modal-content modal-content-demo">
                                              <div class="modal-header">
                                                  <h6 class="modal-title"> <?php echo e($user->student->name ?? '---'); ?>
                                                  ...
                                                  <div class="listgroup-example ">
                                                      <ul class="list-group">
                                                          <li> <?php echo e(__('dash.name')); ?> :
                                                              <?php echo e($user->student->name ?? '---'); ?></li>
                                                          <li> <?php echo e(__('dash.email')); ?> :
                                                              <?php echo e($user->student->email ?? '---'); ?></li>
                                                          <li>Contact:
                                                              <ul class="list-style-disc">
                                                                  <li><?php echo e(__('dash.skype_id')); ?> :
                                                                      <?php echo e($user->student->profile->skype_id ?? '---'); ?>

                                                                  </li>
                                                                  <li><?php echo e(__('dash.zoom_url')); ?> :
                                                                      <?php echo e($user->student->profile->zoom_url ?? '---'); ?>
...
<?php /**PATH /var/www/vhosts/xdenglish.net/app.xdenglish.net/resources/views/dashboard/lessons/type/admin.blade.php ENDPATH**/ ?>