        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data.slots, function(k, v) {
                    ...
                    <div class="mr-4">\n\
                        <figure class="m-0">\n\
                            <img src="https://app.lingualbox.com/_next/image?url=https%3A%2F%2Flingualbox.s3.amazonaws.com%2Fuploads%2Fuser%2Favatar%2F392%2Fprofile_jaykee.jpg&w=96&q=75" alt="">\n\
                        </figure>\n\
                    </div>\n\
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\xdenglish\resources\views/dashboard/booking_calender/index.blade.php ENDPATH**/ ?>