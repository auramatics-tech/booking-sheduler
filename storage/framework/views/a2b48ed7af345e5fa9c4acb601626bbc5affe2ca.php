...
<?php $__env->startSection('title'); ?>
    <?php echo e(__('dash.edit')); ?> <?php echo e(__('dash.lessons')); ?>
            ...
            <div class="card-body">
                <div class="col-lg-12 margin-tb">
                    <div class="pull-right">
                        <a class="btn btn-primary btn-sm" href="<?php echo e(route('lessons.index')); ?>">
                ...
                <?php echo Form::model($lesson, ['method' => 'PATCH', 'route' => ['lessons.update', $lesson->id]]); ?>
                ...
                <div class="row mg-b-20">
                    ...
                    <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                        ...
                        <input id="datetimepickerstart" class="form-control form-control-sm mg-b-20" name="start"
                            required="" type="text" value="<?php echo e($lesson->start); ?>">
                    ...
                    <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                        ...
                        <input id="datetimepickerend" class="form-control form-control-sm mg-b-20" name="end"
                            value="<?php echo e($lesson->end); ?>" required="" type="text">
                    </div>
                    ...
                    <div class="parsley-input col-md-12 mg-t-20 mg-md-t-0" id="lnWrapper">
                        ...
                        <select name="students[]" multiple class="select2 form-control  mg-b-20">
                            ...
                            <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php $ss = $lesson->students ?? [] ?>
                                <option <?php if(in_array($v->id, $ss)): ?> selected <?php endif; ?> value="<?php echo e($v->id); ?>">
               ...
               <?php if( ! $lesson->teacher_avraible): ?>
                ...
                <?php if(isset($lesson->teacher_avraible)): ?>
                <?php $__currentLoopData = $lesson->teacher_avraible; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="clearfix"></div>
                <div data-repeater-list="teacher_avraible">
                    <div data-repeater-item  class="row row-sm mg-t-20 items" data-group="test">
                        ...
                        <div class="item-content  parsley-input col-md-4" id="fnWrapper">
                            ...
                            <select class="form-control select2" name="teacher_avraible[teacher_id]">
                                ...
                                <?php $__currentLoopData = $teacher; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option  <?php if($tt['teacher_id'] == $t->id ): ?> selected <?php endif; ?>  
                                        value="<?php echo e($t->id); ?>">
                                        <?php echo e($t->name); ?>
                        ...
                        <div class="item-content parsley-input col-md-3 mg-t-20 mg-md-t-0" id="lnWrapper">
                            ...
                            <select name="teacher_avraible[day]"  class="form-control  mg-b-20">
                                ...
                                <option <?php if($tt['day'] == "monday" ): ?> selected <?php endif; ?>  value="monday" disabled>Monday</option>
                                <option  <?php if($tt['day'] == "tuesday" ): ?> selected <?php endif; ?> value="tuesday">Tuesday</option>
                                <option  <?php if($tt['day'] == "wednesday" ): ?> selected <?php endif; ?> value="wednesday">Wednesday</option>
                                <option  <?php if($tt['day'] == "thursday" ): ?> selected <?php endif; ?> value="thursday">Thursday</option>
                                <option  <?php if($tt['day'] == "friday" ): ?> selected <?php endif; ?> value="friday">Friday </option>
                                <option  <?php if($tt['day'] == "saturday" ): ?> selected <?php endif; ?> value="saturday">Saturday</option>
                                <option  <?php if($tt['day'] == "sunday" ): ?> selected <?php endif; ?> value="sunday" disabled>Sunday</option>
                            </select>
                        </div>
                        ...
                        <div class="item-content parsley-input col-md-3 mg-t-20 mg-md-t-0" id="lnWrapper">
                            ...
                            <input  class="timePickree21 form-control form-control-sm mg-b-20"
                                data-parsley-class-handler="#lnWrapper" name="teacher_avraible[time]"
                                required="" type="text" value="<?php echo e($tt['time']); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-7.4.30\htdocs\xdenglish\resources\views/dashboard/lessons/edit.blade.php ENDPATH**/ ?>