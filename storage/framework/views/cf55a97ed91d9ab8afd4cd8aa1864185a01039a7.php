...
<body>
    <nav class="navbar navbar-expand-md navbar-dark sticky-top bg-dark p-0">
        ...
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav"
            aria-controls="navbarNav" aria-expanded="false" aria-label="<?php echo e(__('Toggle navigation')); ?>">
            ...
            <ul class="navbar-nav mr-auto">
                <li class="nav-item <?php echo e(Route::is('log-viewer::dashboard') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('dashboard.home')); ?>" class="nav-link">
                        <i class="fa fa-dashboard"></i> <?php echo app('translator')->get('Back to System'); ?>
                    </a>
                </li>
                <li class="nav-item <?php echo e(Route::is('log-viewer::dashboard') ? 'active' : ''); ?>">
...
<?php /**PATH D:\xampp-7.4.30\htdocs\xdenglish\resources\views/vendor/log-viewer/bootstrap-4/_master.blade.php ENDPATH**/ ?>